...
nav='''<!-- RALLY_POINT_CORE_NAV_START -->\n<nav class="newsroom-nav newsroom-nav-core" aria-label="Rally Point sections"><a href="#lead">Top Timeline</a><a href="#grid">Live Timelines</a><a href="/stories/">All Timelines</a><a href="/following/">Your Stories</a><a href="/recent/">Recent</a><a href="/archive/">Archive</a><a href="/sources/">Sources</a><a href="/about/">About</a></nav>\n<!-- RALLY_POINT_CORE_NAV_END -->'''
...
ns=re.sub(r'<span>The Wire</span><small>.*?</small>','<span>Live Timelines</span><small>Follow stories as they develop</small>',s,count=1,flags=re.S)
if ns!=s:s=ns;changed=True
try:

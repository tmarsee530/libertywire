...
4. **COMPLETED — Create persistent storyline history / “What changed?” data** — A bounded seven-day history now tracks first seen, last seen, source growth, title evolution, coverage additions, status, and risk context while avoiding no-op rewrites.
